...
1. Mejora visual de proyecto: Adapar todo el proyecto al estilo del home (monocromatico y algo de color), terminar de traducir el contenido y acicalar el modo claro.

2. Reseñas y comentarios: Actualmente existen los usuarios, pero hay que meterles cosas que poder hacer (votos / valoraciones).
3. Preview en vivo del sitio generado, ver si merece la pena o con el auto-despligue es suficiente
4. Chat de refinamiento post-generación: En lugar de solo regenerar el plan con un prompt, un mini-chat donde el usuario diga "quiero que la home tenga un hero más grande" o "añade un filtro por categoría" y el LLM modifique solo el fichero relevante.
